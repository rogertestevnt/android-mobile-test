...
import com.mlsdev.mlsdevstore.databinding.FragmentEditPersonalInfoBinding
...
class EditPersonalInfoFragment : BaseFragment() {
    ...
    lateinit var binding: FragmentEditPersonalInfoBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        lifecycle.addObserver(viewModel)
        binding = FragmentEditPersonalInfoBinding.inflate(inflater)
